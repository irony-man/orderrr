"""
Django settings for orderrr project.
...
DISCOUNT_FEE = float(os.getenv("ODR_DISCOUNT_FEE"))
DISCOUNT_FEE_APPLICABLE_ON = float(os.getenv("ODR_DISCOUNT_FEE_APPLICABLE_ON"))
